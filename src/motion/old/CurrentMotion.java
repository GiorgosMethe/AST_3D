...
public class CurrentMotion {
	...
	public CurrentMotion(String currentMotionPlaying, int startMotionCyrcles,
			int currentMotionCyrcles, int endMotionCyrcles, int MotionPose,
			int InitCyrcles, boolean PoseEnding) {
