...
public class ActionEffector {
	...
	public static void Act(){
		...
		if(ActionPlaying.getActionPlaying() !=null){
				...
				}else if(ActionPlaying.getActionPlaying().getAction().equalsIgnoreCase("WalkToCoordinate")){
					
					Coordinate target = new Coordinate(ActionPlaying.getActionPlaying().getParametres1(), ActionPlaying.getActionPlaying().getParametres2());
