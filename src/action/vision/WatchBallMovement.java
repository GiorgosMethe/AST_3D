...
import coordination.test.NewAlgorithm;
...
public class WatchBallMovement {
	...
	public static void Watch(){
		...
		if(BallObservationsPrevious.size() < 30){
			...
			BallObservationsPrevious.add(LocalizationResults.getBall_location());
			...
			double distance = TriangleLocalization.FindDistanceAmong2Coordinates(a, b);
			double angle = TriangleLocalization.FindAngleBetweenCoordinates(a, b);
