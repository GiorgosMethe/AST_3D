...
\title{Player Behavior and Team Strategy\\for the RoboCup 3D Simulation League}
 ...
 {\gr
  ...
  \begin{center}
    ...
    {\large \sc {\href{http://www.ece.tuc.gr}{Τμήμα Ηλεκτρονικών Μηχανικών και Μηχανικών Υπολογιστών}} \par}
      \vspace*{20mm}
    { \Large {\bfseries {Συμπεριφορά Παικτών και Στρατηγική Ομάδας\\
    για το Πρωτάθλημα {\en RoboCup 3D Simulation}}} \par}
