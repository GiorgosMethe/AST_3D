...
\begin{algorithmic}[1]
\STATE {\bf Inputs: }$Coordination Messages = \lbrace M_{1},M_{2},...,M_{N-1} \rbrace, N = number of players $
\STATE {\bf Outputs: }$Actions = \lbrace A_{1},A_{2},...,A_{N-1} \rbrace$
\IF {$ Step == 1$ }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Coordination's Beliefs}
...
\subsection{Ball's Position Weighted Samples}
...
\section{Possible Subsets in Coordination Process}
...
\section{Active Positions' Calculation}
...
\subsection{Active Players' Best Mapping}
...
\subsection{Properties for Active's Mapping Cost}
