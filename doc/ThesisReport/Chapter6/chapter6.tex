...
\section{L3M-SIM}
L3M\-SIM~\cite{L3MSIM} members mainly comes from the standard platform league, where the french team is named L3M. As a part of the L3M team has decided to experiment the 3D Simulation Soccer League. Their first participation was in RoboCup 2011, in Istanbul. Their major concern which is presented in their team description paper was locomotion, and cooperation parts of their project.
