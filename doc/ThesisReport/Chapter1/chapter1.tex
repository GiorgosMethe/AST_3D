...
\paragraph{Humanoid League}\mbox{} \\
...
\begin{figure}[!h] 
  \begin{center}
    \subfigure{\includegraphics[height=4cm]{Chapter1/figures/kid2011.jpg}}
    \subfigure{\includegraphics[height=4cm]{Chapter1/figures/teen2011.jpg}}
    \subfigure{\includegraphics[height=4cm]{Chapter1/figures/adult2011.jpg}}
  \end{center}
  \caption{Humanoid Kid, Teen, Adult-Size at Robocup 2011.}
  \label{fig:HumanoidCaption}
\end{figure}

\paragraph{Middle-Size League}\mbox{} \\
...
\paragraph{Simulation League}\mbox{} \\
...
\begin{figure}[!h] 
  \begin{center}
    \subfigure{\includegraphics[height=5cm]{Chapter1/figures/2D.jpg}}
    \subfigure{\includegraphics[height=5cm]{Chapter1/figures/3d.png}}
  \end{center}
  \caption{Simulation League 2D vs 3D.}
  \label{fig:sim2d3d}
\end{figure}

\paragraph{Small-Size League}\mbox{} \\
...
\paragraph{Standard Platform League}\mbox{} \\
...
Greece participates in this league (RoboCup 2008, 2009, 2011) with team ``P.A.N.D.O.R.A'' [\url{http://www.auth.gr}] based at the Aristotle University of Thessaloniki. Figure~\ref{fig:pandora} shows a wheeled robot in RoboCupRescue robot competition.

\begin{figure}[htb!]
\centering
  \includegraphics[width=0.6\textwidth]{Chapter1/figures/rescue.jpg}
  \caption{RoboCupRescue Robot League at RoboCup.}
  \label{fig:pandora}
\end{figure}
...
\centering
  ...
  \caption{RoboCupRescue Simulation League at RoboCup.}
  \label{fig:SimRescue}
\end{figure}
