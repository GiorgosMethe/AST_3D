...
\ifpdf
    \pdfinfo { /Title  (Thesis)
               ...
               /Subject (TucAgent3D: Player Behavior and Team Strategy in SimSpark Soccer Simulation 3D)
 ...
 {\gr
  ...
  \begin{center}
    ...
    {\large \sc {\href{http://www.ece.tuc.gr}{Τμήμα Ηλεκτρονικών Μηχανικών και Μηχανικών Υπολογιστών}} \par}
      \vspace*{20mm}
    { \Large {\bf Συμπεριφορά Παικτών και Στρατηγική Ομάδας για το Πρωτάθλημα {\en RoboCup 3D Simulation}} \par}
